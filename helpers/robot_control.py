...
class RobotController:
    ...
    def send_command(self, command: Union[str, Command], duration :int=1000, velocity: int=150):
    ...
    def move_forward(self, duration: int=1000, velocity: int=150):
        self.send_command(Command.MF, duration=duration, velocity=velocity)

    def move_backward(self, duration: int=1000, velocity: int=150):
        self.send_command(Command.MB, duration=duration, velocity=velocity)

    def turn_right(self, duration: int=1000, velocity: int=150):
        self.send_command(Command.TR, duration=duration, velocity=velocity)

    def turn_left(self, duration: int=1000, velocity: int=150):
        self.send_command(Command.TL, duration=duration, velocity=velocity)

    def park_robot(self, duration: int=1000, velocity: int=150):
